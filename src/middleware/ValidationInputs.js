...
export const validationCreateUser = [
    ...
    check('confirmPassword', 'The Confirm password is min 6 characters').isLength({ min: 6}),
    check('role','Add role , example.- ROLE_USER or ROLE_ADMIN ').not().isEmpty().toUpperCase(),
